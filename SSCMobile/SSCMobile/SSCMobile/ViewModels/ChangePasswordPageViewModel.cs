...
namespace SSCMobile.ViewModels
{
    public class ChangePasswordPageViewModel : ViewModelBase
    {
        ...
        public ChangePasswordPageViewModel(IUserDialogs userDialogs, IAppSettings appSettings, IPageDialogService pageDialogService, INavigationService navigationService, IAccountService accountService) : base(navigationService, appSettings, pageDialogService)
        {
        ...
        public async override void OnNavigatedTo(INavigationParameters parameters)
        {
            ...
            UserEmail.Value = _settings.Email.Trim();
        ...
        private async Task ExecuteSubmitCommandAsync()
        {
            try
            {
                ...
                if (_userEmail.IsValid && _userPassword.IsValid && _userPassword.IsValid && _userConfrmPassword.IsValid)
                {
                    ...
                    {
                        IsBusy = false;
                        await PageDialogService.DisplayAlertAsync(null, "Password has been change.", "Ok");
